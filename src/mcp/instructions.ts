...
export const SERVER_INSTRUCTIONS = `Veridex returns the minimal, provenance-tagged signal slice of this codebase.
...
- Secondary tools (search, deps, refs, callers, impact, node) exist but are hidden by
  default to keep tool choice simple. Set VERIDEX_MCP_TOOLS=all to expose them.`;
